...
var BOX_FACES = [
	{
		name: FACES.FRONT,
		map: createTextSprite("FRONT", { fontSize: 50, font: "Arial Narrow, sans-serif" })
	},
	{
		name: FACES.RIGHT,
		map: createTextSprite("RIGHT", { fontSize: 50, font: "Arial Narrow, sans-serif" })
	},
	{
		name: FACES.BACK,
		map: createTextSprite("BACK", { fontSize: 50, font: "Arial Narrow, sans-serif" })
	},
	{
		name: FACES.LEFT,
		map: createTextSprite("LEFT", { fontSize: 50, font: "Arial Narrow, sans-serif" })
	},
	{
		name: FACES.TOP,
		map: createTextSprite("TOP", { fontSize: 50, font: "Arial Narrow, sans-serif" })
	},
	{
		name: FACES.BOTTOM,
		map: createTextSprite("BOTTOM", { fontSize: 50, font: "Arial Narrow, sans-serif" })
	}
];
var CORNER_FACES = [
